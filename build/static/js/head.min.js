! function (t, e) {
    ...
    function a(r, n) {
       ...
       100 <= n && (n = 100), r.hasAttribute("data-progressjs") && setTimeout(function () {
          ...
          ! function (t, e, r) {
             ...
             ! function t(e, r, n) {
                var s = Math.abs(r - n);
                s < 3 ? i = 30 : s < 20 ? i = 20 : intervanIn = 1, r - n != 0 && (e.innerHTML = (o ? ++r : --r) + "%", setTimeout(function () {
                   t(e, r, n)
                }, i))
             }(t, e, r)
          }(t, e, parseInt(n))
    ...
    function o() {
       ...
       for (var t = parseInt(this._targetElement[0].getAttribute("data-progressjs")), e = 0, r = this._targetElement.length; e < r; e++) {
          ...
          o < 100 && (a.call(this, n, 100), i = 500),
             function (t, e) {
                setTimeout(function () {
                   t.parentNode.className += " progressjs-end", setTimeout(function () {
                      t.parentNode.parentNode.removeChild(t.parentNode), e.removeAttribute("data-progressjs")
                   }, 1e3)
                }, i)
             }(s, n)
       }
       if (window._progressjsIntervals[t]) try {
          clearInterval(window._progressjsIntervals[t]), window._progressjsIntervals[t] = null, delete window._progressjsIntervals[t]
       } catch (t) {}
    }
    var i = function (t) {
    ...
    return i.version = "0.1.0", i.fn = r.prototype = {
       ...
       set: function (t) {
          return function (t) {
             for (var e = 0, r = this._targetElement.length; e < r; e++) a.call(this, this._targetElement[e], t)
          }.call(this, t), this
       },
       increase: function (t) {
       ...
       autoIncrease: function (t, e) {
          return function (t, e) {
             ...
             void 0 !== window._progressjsIntervals[n] && clearInterval(window._progressjsIntervals[n]), window._progressjsIntervals[n] = setInterval(function () {
                s.call(r, t)
             }, e)
          }.call(this, t, e), this
       },
       ...
       onbeforeend: function (t) {
          if ("function" != typeof t) throw new Error("Provided callback for onbeforeend was not a function");
          return this._onBeforeEndCallback = t, this
       },
       onbeforestart: function (t) {
          if ("function" != typeof t) throw new Error("Provided callback for onbeforestart was not a function");
          return this._onBeforeStartCallback = t, this
       },
       onprogress: function (t) {
          if ("function" != typeof t) throw new Error("Provided callback for onprogress was not a function");
